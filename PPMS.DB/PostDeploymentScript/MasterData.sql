...
If not exists(Select 'X' from [dbo].[UserRoleMapping] where Id=1) BEGIN Insert into UserRoleMapping([Id],[RoleId],[UserId])values(1,1,1) END
If not exists(Select 'X' from [dbo].[UserRoleMapping] where Id=2) BEGIN Insert into UserRoleMapping([Id],[RoleId],[UserId])values(2,2,2) END
If not exists(Select 'X' from [dbo].[UserRoleMapping] where Id=3) BEGIN Insert into UserRoleMapping([Id],[RoleId],[UserId])values(3,3,3) END
